import * as images from "../../src/jsScripts/navigator";
...
(function (k, d) {
  ...
  function y(a, b, c) {
    ...
    this.moveForwardAnimation = new m.Tween();
    c = function (b) {
      if (this.material) {
        ...
        this.scaleDownAnimation = new m.Tween(this.scale)
          .to({ x: c.x, y: c.y }, 500)
          .easing(m.Easing.Elastic.Out);
        this.moveForwardAnimation = new m.Tween(this.position)
          .to({ x: 100 + c.x, y: c.y, z: c.z }, 500)
          .easing(m.Easing.Elastic.Out);
        this.material.map = b;
    ...
    this.addEventListener("hoverenter", this.onCustomHoverStart);
    ...
    var b = (this.options = Object.assign(
      {
        ...
        controlBar: !0,
        controlButtons: ["fullscreen", "setting", "video", "ZoomIn", "ZoomOut"],
  ...
  var ja = "^0.105.2".replace(/[^0-9.]/g, ""),
    ...
    t = {
      ...
      FullscreenEnter: images.FullscreenEnterImageData,
      FullscreenLeave:
      ...
      ZoomIn: images.ZoomInIconData,
      ZoomOut: images.ZoomOutIconData,
    },
    fa = {
  ...
  y.prototype = Object.assign(Object.create(d.Sprite.prototype), {
    ...
    onClick: function (a) {
      if (
        viewer &&
        viewer.panorama &&
        viewer.panorama.children &&
        viewer.panorama.children.length > 0
      ) {
        for (
          let pIndex = 0;
          pIndex < viewer.panorama.children.length;
          pIndex++
        ) {
          if (
            !OpenedViewerElement ||
            (OpenedViewerElement && OpenedViewerElement != this.uuid)
          ) {
            viewer.panorama.children[pIndex].onDismiss();
          }
        }
      }
      if (
    ...
    onHover: function () {},
    onCustomHoverStart: function () {
      if (this.getContainer()) {
        this.container.style.cursor =
          this.cursorStyle || (this.mode === q.NORMAL ? "pointer" : "default");
      }
    },
  ...
  L.prototype = Object.assign(Object.create(d.EventDispatcher.prototype), {
    ...
    addControlButton: function (a) {
      switch (a) {
        ...
        case "video":
          ...
          break;
        case "ZoomIn":
          this.zoomInElement = a = this.createZoomInButton();
          break;
        case "ZoomOut":
          this.videoElement = a = this.createZoomOutButton();
          break;
        default:
          return;
      }
    ...
    createZoomInButton: function () {
      ZoomInButton = this.createCustomItem({
        style: {
          backgroundImage: 'url("' + t.ZoomIn + '")',
          webkitTransition: this.DEFAULT_TRANSITION,
          transition: this.DEFAULT_TRANSITION,
        },
        onTap: function (b) {
    ...
    createZoomOutButton: function () {
      ZoomOutButton = this.createCustomItem({
        style: {
          backgroundImage: 'url("' + t.ZoomOut + '")',
          webkitTransition: this.DEFAULT_TRANSITION,
          transition: this.DEFAULT_TRANSITION,
        },
        onTap: function (b) {
      ...
      if (
        ...
        var d = this.createCustomItem({
          ...
          onTap: function (a) {
            ...
            if (c) {
              this.style.backgroundImage = 'url("' + t.FullscreenLeave + '")';
              ZoomInButton.style.backgroundImage = "";
              ZoomOutButton.style.backgroundImage = "";
            } else {
              this.style.backgroundImage = 'url("' + t.FullscreenEnter + '")';
              ZoomInButton.style.backgroundImage = 'url("' + t.ZoomIn + '")';
              ZoomOutButton.style.backgroundImage = 'url("' + t.ZoomOut + '")';
            }
          ...
          e.addEventListener(
            ...
            function (e) {
              ...
              for (let index = 0; index < 20; index++) {
                e.target.position.z = e.target.position.z - 1;
                e.target.scale.x = e.target.scale.x - 0.05;
                e.target.scale.y = e.target.scale.y - 0.05;
                e.target.scale.z = e.target.scale.z - 0.05;
              }

              e.target.material.opacity = e.target.material.opacity - 0.7;
              setTimeout(() => {
                // console.log(t.Arrow);
                // console.log(e.target.showAnimation);
                this.dispatchEvent({
                  type: "panolens-viewer-handler",
                  method: "setPanorama",
                  data: a,
